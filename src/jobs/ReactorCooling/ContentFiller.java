...
public class ContentFiller {
	...
	public static void fill() {
		...
		dosElement.add(new DosElement(9,7,2,"change parameter.exe"));
		dosElement.add(new DosElement(10,7,2,"flow rate reader.exe"));
		dosElement.add(new DosElement(12,8,2,"change parameter.exe"));
		dosElement.add(new DosElement(13,8,2,"temperatur reader.exe"));
		dosElement.add(new DosElement(15,2,2,"change parameter.exe"));
		dosElement.add(new DosElement(16,2,2,"reservoir level reader.exe"));
		dosElement.add(new DosElement(19,18,2,"change parameter.exe"));
		dosElement.add(new DosElement(20,18,2,"temperatur reader.exe"));
