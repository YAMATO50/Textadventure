	...
	public static void sublimation() {
		...
		if (choice == 1) {
			...
			if (choice > (100 - sublimationRate) / 5) {
				...
				System.out.println();
				System.out.println("Neue K¸hlwassertemperatur: " + TemperatureReader.temperature + "∞C");
			}
			...
			case 1:
				...
				if (choice == 1) {
					...
					if (choice > (100 - reservoirSublimationRate) / 5) {
						...
						System.out.println();
						System.out.println("Neuer Reservoirf¸llstand: " + ReservoirLevelReader.reservoirLevel + "%");
					}
			...
			case 1:
				...
				if (choice == 1) {
					...
					if (choice > (100 - refluxSublimationRate) / 5) {
						...
						System.out.println();
						System.out.println("Neue R¸ckwassertemperatur: " + RefluxTemperatureReader.temperature + "∞C");
					}
