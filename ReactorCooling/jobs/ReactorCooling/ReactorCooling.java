...
public class ReactorCooling {
	...
	private static void introduction() {
		...
		TextAdventure.wait(1000);
		TextTools.slowTextln("Hi, " + Config.save.playerName + " Herzlich Willkommen in der Reaktorkuppel!", talkingSpeed);
		TextTools.slowTextln("Ich bin Tobias Ingram, der Leiter der Reaktorkuppel.", talkingSpeed);
		TextTools.slowTextln("Du bist also hier um die Reaktorkühlung zu prüfen. Hast du das schonmal gemacht?", talkingSpeed);
		System.out.println();
		...
		if (answer == 1) {
			TextTools.slowTextln("Ich kann mir einfach nie merken wer schonmal hier war und wer nicht!", talkingSpeed);
			TextTools.slowTextln("Na dann leg los! Du weißt ja wie es geht.", talkingSpeed);
		} else {
			TextTools.slowTextln("Okay, dann erkläre ich dir mal alles!"
					...
					+ "\n" + "Also dann! Viel erfolg!", talkingSpeed);
		}
		System.out.println();
	...
	private static void dos() {
		...
		if (Parameters.succes) {
			...
			TextAdventure.wait(1000);
			TextTools.slowTextln("Oh du bist fertig! Sehr schön. Dann lass mich mal sehen ob du alles richtig gemacht hast.",talkingSpeed);
			...
			if (DOS.errorOccured) {
				...
				do {
					...
					case 2:
						...
						TextTools.slowTextln("hmmm... Ich werde das prüfen.", talkingSpeed);
						...
						TextTools.slowTextln("Tatsächlich, du hast recht. Bitte entschuldige meine Reaktion. Ich werde dir dein Gehalt überweisen."
								+ "\n" + "Einen schönen tag dir noch!", talkingSpeed);
						break;
					default:
						System.out.println("Bitte gib eine gültige zahl ein!");
						choice = -1;
	...
	private static void questionSection() {
		...
		while (stay) {
			...
			case 2:
				...
				break;
			case 3:
				TextTools.slowTextln("Alles klar. Einen schönen tag noch!", talkingSpeed);
				stay = false;
			}
